...
print('Runs scored by player 1 if they played 60 more balla is', run_Player1 * 2)
print('Runs scored by player 2 if they played 60 more balla is', run_Player2 * 2)
print('Runs scored by player 3 if they played 60 more balla is', run_Player3 * 2)
